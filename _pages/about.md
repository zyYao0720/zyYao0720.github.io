...
<h4 style="margin-top: var(--space-4);">Education</h4>
<ul>
...
{% endif %}
{% if site.data.pi[0].experience %}
<h4 style="margin-top: var(--space-4);">Experience</h4>
<ul>
{% for experience in site.data.pi[0].experience %}
<li>{{ experience | replace: "-","&#8211;" }}</li>
{% endfor %}
</ul>
{% endif %}
</div>
